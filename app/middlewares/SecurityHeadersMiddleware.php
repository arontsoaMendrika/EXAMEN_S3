...
class SecurityHeadersMiddleware
{
	...
	public function before(array $params): void
	{
		...
		$csp = "default-src 'self'; script-src 'self' 'unsafe-inline' https://code.jquery.com; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self'; font-src 'self' data:;";
